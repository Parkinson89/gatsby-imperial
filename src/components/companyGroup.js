...
import "../styles/components/CompanyGroup.scss";
    ...
    <div className="company-group">
      ...
      <ul className="company-group__list">
        <li className="company-group__item">
          ...
          <p className="company-group__company-label">- ООО «ИМПЕРИУМ ТРЭЙДИНГ ЭНД ИНЖИНИРИНГ» </p>
        </li>
        <li className="company-group__item">
          <Link className="company-group__link" to="/services">
            <img className="company-group__logo" src={IS} alt="Логотип ИМПЕРИУМ СЕКЬЮРИТИ." />
          </Link>
          <p className="company-group__company-label">- ООО ОХРАННОЕ АГЕНТСТВО «ИМПЕРИУМ СЕКЬЮРИТИ» </p>
        </li>
        <li className="company-group__item">
          ...
          <p className="company-group__company-label">- ООО ОХРАННОЕ АГЕНТСТВО «ИМПЕРИУМ СЕКЬЮРИТИ СЕРВИС» </p>
        </li>
      </ul>
    </div>
  );
