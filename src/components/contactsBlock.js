...
import "../styles/components/ContactsBlock.scss";

function ContactsBlock() {
  return (
    <section className="contacts-block">
      <svg className="contacts-block__sprite">
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308" fill="#fff" id="telephone">
          <g>
            <path
	...
	C233.168,179.508,230.845,178.393,227.904,176.981z"
        ...
        <symbol viewBox="0 0 19 13" fill="none" xmlns="http://www.w3.org/2000/svg" id="email">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <symbol viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg" id="geo">
          <path
      ...
      <div className="contacts-block__wrapper-for-info">
        ...
        <div className="contacts-block__info-block">
          ...
          <a className="contacts-block__contact-info" target="blank" href="mailto:imperium.rostov@gmail.com">
