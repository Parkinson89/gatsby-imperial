    ...
    <section className="contacts-block">
      ...
      <div className="contacts-block__wrapper-for-info">
        <div className="contacts-block__info-block">
          <a className={`contacts-block__contact-info ${color}`} href="tel:+78632107858">
            8 (863) 210-78-58
          </a>
        </div>
        <div className="contacts-block__info-block">
          <span className={`contacts-block__contact-info ${color}`}>пн-пт с 9:00 по 18:30</span>
        </div>
        <div className="contacts-block__info-block">
          <a className={`contacts-block__contact-info ${color}`} target="blank" href="mailto:imperium.rostov@gmail.com">
            imperium.rostov@gmail.com
          </a>
        </div>
        <div className="contacts-block__info-block">
          <a
            className={`contacts-block__contact-info ${color}`}
            target="blank"
