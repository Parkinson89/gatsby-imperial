      ...
      <div className="security__main-wrapper">
        ...
        <div className="security__el-wrapper">
          ...
          <p className="security__text-services-price">
            ...
            рассчитывается индивидуально, в рамках коммерческих предложений,
            исходя из Технических заданий, проектов и т.д., на основании
            действующих в момент расчёта цен на услуги, поставщиков, а также в
            рамках ценообразования сметных расчётов.
          </p>
        </div>
